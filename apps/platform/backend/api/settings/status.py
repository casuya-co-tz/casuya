...
_ENV_META = {
    ...
    "cloudflare_account_id": ("Cloudflare Account ID", "Integrations", False),
    "cloudflare_api_token": ("Cloudflare API Token", "Integrations", True),
    "r2_access_key_id": ("R2 Access Key ID", "Integrations", True),
    "r2_secret_access_key": ("R2 Secret Access Key", "Integrations", True),
    "r2_bucket_name": ("R2 Bucket Name", "Integrations", False),
    "r2_s3_endpoint": ("R2 S3 Endpoint", "Integrations", False),
    "public_assets_base": ("Public Assets Base", "Files", False),
