...
;
// i18n/swahili/navigation.js — navigation + skip-link translations.
...
;
// i18n/swahili/hero.js — hero + weekly-card + mock-UI translations.
...
window.SW = Object.assign(window.SW || {}, {
    ...
    "demo.sign_in_desc": "Endelea ulipokosimama — masomo, maswali na maendeleo, kwenye sehemu moja.",
    "demo.email": "Barua Pepe",
    "demo.password": "Nenosiri",
    "demo.forgot_password": "Umesahau nenosiri?",
    "demo.remember_me": "Nikumbuke barua pepe yangu",
    "demo.remember_desc": "Nibaki nimeingia kwa siku 30",
    "demo.sign_in": "Ingia",
    "demo.submit": "Ingia kwenye akaunti yako ya Casuya",
    "demo.or": "AU",
    "demo.google": "Ingia na Google",
    "demo.facebook": "Ingia na Facebook",
...
;
// i18n/swahili.js — merged Swahili dictionary. Loaded LAST after i18n/swahili/*.js
// on static pages (classic scripts) and concatenated into role bundles. Exposes
// the single global `SW` (the object previously declared inline in this file).
