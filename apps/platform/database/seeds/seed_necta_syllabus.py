...
NECTA_SYLLABUS: list[dict] = [
 ...
 'topics': [{'title': 'NUMBERS',
            ...
            {'title': 'INDICES AND LOGARITHMS',
             ...
             'periods': 20,
             'weight': 'high',
             'subtopics': [{'title': 'Indices (laws of exponents)',
                            'code': '1.1',
                            'order': 1,
                            'periods': 10,
                            'outcomes': [('State and apply the laws of indices: product, quotient, power, '
                                          'zero and negative indices',
                                          'application',
                                          1),
                                         ('Express numbers in standard form using indices',
                                          'application',
                                          2)]},
                           {'title': 'Logarithms',
                            'code': '1.2',
                            'order': 2,
                            'periods': 10,
                            'outcomes': [('Define logarithms and relate them to indices', 'comprehension', 1),
                                         ('Find logarithms of numbers using tables and calculators',
                                          'application',
                                          2),
                                         ('Apply logarithms to solve multiplication, division and power '
                                          'problems',
                                          'application',
                                          3)]}]},
            {'title': 'ALGEBRAIC EXPRESSIONS',
             ...
             'periods': 22,
             'weight': 'high',
             'subtopics': [{'title': 'Expansion and factorization',
                            'code': '2.1',
                            'order': 1,
                            'periods': 10,
                            'outcomes': [('Expand algebraic expressions using distributive property',
                                          'application',
                                          1),
                                         ('Factorize algebraic expressions by taking common factors',
                                          'application',
                                          2),
                           ...
                           {'title': 'Algebraic fractions',
                            ...
                            'order': 2,
                            'periods': 6,
                            'outcomes': [('Simplify algebraic fractions', 'application', 1),
            ...
            {'title': 'EQUATIONS',
             ...
             'periods': 24,
             'weight': 'high',
             'subtopics': [{'title': 'Linear equations in two unknowns',
                            'code': '3.1',
                            'order': 1,
                            'periods': 10,
                            'outcomes': [('Solve simultaneous linear equations in two unknowns by '
                                          'substitution and elimination',
                                          'application',
                                          1),
                                         ('Formulate simultaneous equations from word problems',
                                          'analysis',
                                          2)]},
                           {'title': 'Quadratic equations',
                            ...
                            'order': 2,
                            'periods': 10,
                            'outcomes': [('Solve quadratic equations by factoring, completing the square and '
                                          'formula',
                                          'application',
                                          1),
                                         ('Formulate quadratic equations from practical problems',
                                          'analysis',
                                          2)]},
                           {'title': 'Linear inequalities',
                            ...
                            'order': 3,
                            'periods': 4,
                            'outcomes': [('Solve simultaneous linear inequalities in two unknowns',
                                          'application',
                                          1)]}]},
            {'title': 'TRIGONOMETRY',
             'code': '4.0',
             ...
             'subtopics': [{'title': 'Trigonometric ratios',
                            ...
                            'order': 1,
                            'periods': 10,
                            'outcomes': [('Define sine, cosine and tangent of an angle', 'knowledge', 1),
                                         ('Calculate trigonometric ratios of angles using tables and '
                                          'calculators',
                                          'application',
                                          2)]},
                           {'title': 'Trigonometric ratios of special angles',
                            ...
                            'order': 2,
                            'periods': 6,
                            'outcomes': [('Determine trigonometric ratios of 30, 45, 60, 90, 120, 135, 150, '
                                          '180, 210, 225, 240, 270, 300, 315, 330 and 360 degrees',
                                          'application',
                                          1)]},
            ...
            {'title': 'POLYGONS',
             ...
             'periods': 18,
             'weight': 'high',
             'subtopics': [{'title': 'Types and properties of polygons',
                            'code': '5.1',
                            'order': 1,
                            'periods': 8,
                            'outcomes': [('Identify types of polygons: triangles, quadrilaterals, pentagons, '
                                          'hexagons etc.',
                                          'knowledge',
                                          1),
                           ...
                           {'title': 'Congruence and similarity',
                            ...
                            'order': 2,
                            'periods': 6,
                            'outcomes': [('Identify conditions for congruence of triangles: SSS, SAS, ASA, '
                                          'RHS',
                                          'knowledge',
                                          1),
                           ...
                           {'title': 'Pythagoras theorem',
                            ...
                            'order': 3,
                            'periods': 4,
                            'outcomes': [('Apply Pythagoras theorem to find unknown sides of right-angled '
                                          'triangles',
                                          'application',
                                          1),
            ...
            {'title': 'MATHEMATICAL ECONOMICS',
             ...
             'periods': 12,
             'weight': 'medium',
             'subtopics': [{'title': 'Compound interest',
                            'code': '6.1',
                            'order': 1,
                            'periods': 6,
                            'outcomes': [('Calculate compound interest using A = P(1 + R/100)^n',
                                          'application',
                                          1),
                           ...
                           {'title': 'Hire purchase',
                            ...
                            'order': 2,
                            'periods': 6,
                            'outcomes': [('Calculate hire purchase price including deposit and interest',
                                          'application',
                                          1),
            ...
            {'title': 'TRANSFORMATIONS',
             ...
             'periods': 14,
             'weight': 'medium',
             'subtopics': [{'title': 'Reflection',
                            'code': '7.1',
                            'order': 1,
                            'periods': 4,
                            'outcomes': [('Identify and draw reflections of shapes in given mirror lines',
                                          'application',
                                          1),
                                         ('Identify properties preserved under reflection',
                                          'comprehension',
                                          2)]},
                           {'title': 'Rotation',
                            'code': '7.2',
                            'order': 2,
                            'periods': 4,
                            'outcomes': [('Rotate shapes about a given centre through given angles',
                                          'application',
                                          1)]},
                           {'title': 'Translation',
                            'code': '7.3',
                            'order': 3,
                            'periods': 4,
                            'outcomes': [('Translate shapes by given vectors', 'application', 1)]},
                           {'title': 'Enlargement',
                            'code': '7.4',
                            'order': 4,
                            'periods': 2,
                            'outcomes': [('Enlarge shapes with a given scale factor and centre',
                                          'application',
                                          1)]}]},
            {'title': 'NUMBER BASES',
             'code': '1.0',
 ...
 'topics': [{'title': 'INTRODUCTION TO CHEMISTRY',
            ...
            {'title': 'ATOMIC STRUCTURE',
             ...
             'periods': 18,
             'weight': 'high',
             'subtopics': [{'title': 'Atomic models',
                            'code': '1.1',
                            'order': 1,
                            'periods': 6,
                            'outcomes': [("Describe Dalton's, Thomson's, Rutherford's and Bohr's atomic "
                                          'models',
                                          'comprehension',
                                          1),
                                         ('State the structure of an atom: protons, neutrons and electrons',
                                          'knowledge',
                                          2),
                                         ('Explain the changes in the physical and chemical properties of '
                                          'elements across and down the periodic table',
                                          'comprehension',
                                          0)]},
                           {'title': 'Atomic number and mass number',
                            ...
                            'order': 2,
                            'periods': 6,
                            'outcomes': [('Define atomic number Z and mass number A', 'knowledge', 1),
                                         ('Determine number of protons, neutrons and electrons in atoms and '
                                          'ions',
                                          'application',
                                          2),
                                         ('Write electronic configurations of elements', 'application', 3),
                                         ('Use the electronic configuration of an element to locate their '
                           ...
                           {'title': 'The Periodic Table',
                            ...
                            'order': 3,
                            'periods': 6,
                            'outcomes': [('Describe the arrangement of elements in the periodic table',
                                          'comprehension',
                                          1),
                                         ('Identify trends in the periodic table: atomic radius, ionization '
            ...
            {'title': 'CHEMICAL BONDING',
             ...
             'periods': 20,
             'weight': 'high',
             'subtopics': [{'title': 'Ionic bonding',
                            'code': '2.1',
                            'order': 1,
                            'periods': 6,
                            'outcomes': [('Describe ionic bonding with dot-and-cross diagrams',
                                          'comprehension',
                                          1),
                           ...
                           {'title': 'Covalent bonding',
                            ...
                            'order': 2,
                            'periods': 6,
                            'outcomes': [('Describe covalent bonding with dot-and-cross diagrams',
                                          'comprehension',
                                          1),
                           ...
                           {'title': 'Metallic bonding',
                            ...
                            'order': 3,
                            'periods': 4,
                            'outcomes': [('Describe metallic bonding using the sea of electrons model',
                                          'comprehension',
                                          1),
                                         ('Explain properties of metals using metallic bonding',
                                          'comprehension',
                                          2)]},
                           {'title': 'Coordinate bonding and intermolecular forces',
                            ...
                            'order': 4,
                            'periods': 4,
                            'outcomes': [('Describe coordinate (dative) covalent bonding',
                                          'comprehension',
                                          1),
                                         ('Explain intermolecular forces: van der Waals and hydrogen bonding',
                                          'comprehension',
                                          2)]}]},
 ...
 'topics': [{'title': 'BIOLOGY AND ITS APPLICATIONS',
            ...
            {'title': 'GASEOUS EXCHANGE',
             ...
             'periods': 14,
             'weight': 'medium',
             'subtopics': [{'title': 'Gaseous exchange in humans',
                            'code': '1.1',
                            'order': 1,
                            'periods': 6,
                            'outcomes': [('Describe the structure of the human respiratory system',
                                          'comprehension',
                                          1),
                           ...
                           {'title': 'Gaseous exchange in plants',
                            ...
                            'order': 2,
                            'periods': 4,
                            'outcomes': [('Describe gaseous exchange through stomata and lenticels',
                                          'comprehension',
                                          1)]},
                           {'title': 'Respiratory disorders',
                            ...
                            'order': 3,
                            'periods': 4,
                            'outcomes': [('Identify respiratory disorders: asthma, bronchitis, pneumonia, '
                                          'emphysema',
                                          'knowledge',
                                          1),
            ...
            {'title': 'CIRCULATION',
             ...
             'periods': 18,
             'weight': 'high',
             'subtopics': [{'title': 'The human circulatory system',
                            'code': '2.1',
                            'order': 1,
                            'periods': 8,
                            'outcomes': [('Describe the structure and function of the heart',
                                          'comprehension',
                                          1),
                                         ('Trace the path of blood through the body: pulmonary and systemic '
                                          'circulation',
                                          'comprehension',
                                          2),
                                         ('Describe blood composition: red blood cells, white blood cells, '
                                          'platelets, plasma',
                                          'knowledge',
                                          3)]},
                           ...
                           {'title': 'Heart disorders',
                            ...
                            'order': 3,
                            'periods': 4,
                            'outcomes': [('Identify heart disorders: hypertension, heart attack, '
                                          'atherosclerosis',
                                          'knowledge',
                                          1)]}]},
            {'title': 'EXCRETION',
