...
NECTA_SYLLABUS: list[dict] = [
 ...
 'form_start': 1,
 'form_end': 6,
 'topics': [{'title': 'INTRODUCTION TO LABORATORY PRACTICE',
             'code': '1.0',
             'form_level': 1,
             'order': 1,
             'periods': 9,
             'weight': 'medium',
             'subtopics': [{'title': 'Laboratory Rules and Safety',
                            'code': '1.1',
                            'order': 1,
                            'periods': 5,
                            'outcomes': [('state Physics laboratory rules', 'comprehension', 1),
                                         ('explain the safety measures in Physics laboratory',
                                          'comprehension',
                                          2),
                                         ('use the First Aid Kit to render first aid', 'comprehension', 3)]},
                           {'title': 'Basic Principles of scientific Investigation',
                            'code': '1.2',
                            'order': 2,
                            'periods': 4,
                            'outcomes': [('use warning signs in daily life', 'comprehension', 1),
                                         ('explain the concept of scientific investigation',
                                          'comprehension',
                                          2),
                                         ('identify the steps of investigation. scientific',
                                          'comprehension',
                                          3)]}]},
            {'title': 'MEASUREMENT',
             'code': '2.0',
             ...
             'periods': 9,
             'weight': 'medium',
             'subtopics': [{'title': 'Fundamental Quantities',
                            'code': '2.2',
                            'order': 2,
                            'periods': 5,
                            'outcomes': [('explain the concepts of measurement', 'comprehension', 1),
                                         ('state the importance of measurement in real life',
                                          'comprehension',
                                          2),
                                         ('deifne a fundamental quantity', 'comprehension', 3)]},
                           {'title': 'Derived Quantities',
                            'code': '2.3',
                            'order': 3,
                            'periods': 4,
                            'outcomes': [('state the S.I. unit of fundamental quantities; and',
                                          'comprehension',
                                          1),
                                         ('use appropriate instruments for measuring fundamental quantities',
                                          'comprehension',
                                          2),
                                         ('explain derived quantities; and', 'comprehension', 3),
                                         ('Metre rule i', 'comprehension', 4),
                                         ('Spring balance ii', 'comprehension', 5),
                                         ('Beam balance i', 'comprehension', 6),
                                         ('Digital balance', 'comprehension', 7),
                                         ('Measuring cylinder', 'comprehension', 8),
                                         ('Stop watch i', 'comprehension', 9),
                                         ('Solid objects ii', 'comprehension', 10),
                                         ('Spring balance i', 'comprehension', 11),
                                         ('Metre rule ii', 'comprehension', 12),
                                         ('Regular solid e.g. Rectangular wooden blocks of different sizes',
                                          'comprehension',
                                          13),
                                         ('determine the density of a liquid', 'comprehension', 14),
                                         ('deifne the relative density of a substance',
                                          'comprehension',
                                          15)]}]},
            {'title': 'FORCE',
             'code': '3.0',
             ...
             'subtopics': [{'title': 'Concept of Force',
                            ...
                            'order': 1,
                            'periods': 5,
                            'outcomes': [('interpret applications of density and relative density in real '
                                          'life',
                                          'comprehension',
                                          1),
                                         ('explain the concept of force; and', 'comprehension', 2)]},
                           {'title': 'Effects of Forces',
                            'code': '3.3',
                            'order': 3,
                            'periods': 4,
                            'outcomes': [('identify fundamental types of forces; and', 'comprehension', 1),
                                         ('describe the properties of each type of the fundamental forces',
                                          'comprehension',
                                          2),
                                         ('identify effects of forces; and', 'comprehension', 3)]}]},
            {'title': 'ARCHIMEDES PRINCIPLE AND LAW OF FLOTATION',
             'code': '4.0',
             'form_level': 1,
             'order': 4,
             'periods': 17,
             'weight': 'high',
             'subtopics': [{'title': 'Archimedes Principle',
                            'code': '4.1',
                            'order': 1,
                            'periods': 5,
                            'outcomes': [('explain the concept of up thrust', 'comprehension', 1),
                                         ('Verify the Archimedes Principle; and', 'comprehension', 2)]},
                           {'title': 'Law of Flotation',
                            'code': '4.2',
                            'order': 2,
                            'periods': 4,
                            'outcomes': [('distinguish lfoating and sinking of objects', 'comprehension', 1),
                                         ('explain the conditions for a substance to lfoat in lfuids',
                                          'comprehension',
                                          2),
                                         ('state the law of lfotation', 'comprehension', 3),
                                         ('apply the law of lfotation in everyday life', 'comprehension', 4),
                                         ('Test tube i', 'comprehension', 5),
                                         ('Lead shots/bearing i', 'comprehension', 6),
                                         ('water and Kerosene', 'comprehension', 7),
                                         ('Hydrometer i', 'comprehension', 8),
                                         ('Various objects i', 'comprehension', 9),
                                         ('explain the kinetic theory of matter; and', 'comprehension', 10),
                                         ('classify three states of matter', 'comprehension', 11),
                                         ('justify the relationship between tension and extension of a '
                                          'loaded elastic material; and',
                                          'comprehension',
                                          12),
                           ...
                           {'title': 'Surface Tension',
                            ...
                            'order': 3,
                            'periods': 4,
                            'outcomes': [('apply adhesion and cohesion in daily life', 'comprehension', 1),
                                         ('explain the concept of surface tension', 'comprehension', 2)]},
                           {'title': 'Capillarity',
                            'code': '4.4',
                            'order': 4,
                            'periods': 4,
                            'outcomes': [('explain the concept of capillarity; and', 'comprehension', 1),
            ...
            {'title': 'PRESSURE',
             ...
             'subtopics': [{'title': 'Concept of Pressure',
                            ...
                            'order': 1,
                            'periods': 5,
                            'outcomes': [('identify the applications of osmosis in daily life',
                                          'comprehension',
                                          1),
                                         ('explain the concept of pressure; and', 'comprehension', 2),
                                         ('state S.I. unit of pressure', 'comprehension', 3)]},
                           {'title': 'Pressure in Liquids',
                            'code': '5.2',
                            'order': 2,
                            'periods': 4,
                            'outcomes': [('identify the applications of pressure due to solids',
                                          'comprehension',
                                          1),
                                         ('describe the characteristics of pressure in liquids',
                                          'comprehension',
                                          2),
                                         ('solve problems involving pressure in liquids', 'comprehension', 3),
                                         ('explain the principle of a hydraulic press; and',
                                          'comprehension',
                                          4)]},
                           {'title': 'Atmospheric Pressure',
                            ...
                            'order': 3,
                            'periods': 4,
                            'outcomes': [('describe the existence of atmospheric pressure',
                                          'comprehension',
                                          1),
                                         ('identify the applications of atmospheric pressure; and',
                                          'comprehension',
                                          2),
                                         ('measure atmospheric pressure', 'comprehension', 3),
                                         ('state S.I. unit of work; and', 'comprehension', 4),
                                         ('determine the work done by an applied force', 'comprehension', 5),
                                         ('state S.I. unit of energy', 'comprehension', 6),
                                         ('identify different forms of energy', 'comprehension', 7),
                           ...
                           {'title': 'Power',
                            ...
                            'order': 4,
                            'periods': 4,
                            'outcomes': [('state the principle of conservation of energy; and',
                                          'comprehension',
                                          1),
                                         ('explain the uses of mechanical energy', 'comprehension', 2),
                                         ('explain the concept of power', 'comprehension', 3)]}]},
            {'title': 'LIGHT',
             'code': '6.0',
             'form_level': 1,
             'order': 6,
             'periods': 26,
             'weight': 'high',
             'subtopics': [{'title': 'Sources of Light',
                            'code': '6.1',
                            'order': 1,
                            'periods': 5,
                            'outcomes': [('determine the rate of doing work', 'comprehension', 1),
                                         ('explain the concept of light', 'comprehension', 2),
                                         ('identify sources of light; and', 'comprehension', 3)]},
                           {'title': 'Propagation and Transmission of Light',
                            'code': '6.2',
                            'order': 2,
                            'periods': 5,
                            'outcomes': [('explain the concept of rays and beam of light',
                                          'comprehension',
                                          1),
                                         ('verify that light rays travels in straight line; and',
                                          'comprehension',
                                          2),
                                         ('identify transparent, translucent and opaque materials',
                                          'comprehension',
                                          3)]},
                           {'title': 'Relfection of Light',
                            'code': '6.3',
                            'order': 3,
                            'periods': 4,
                            'outcomes': [('explain the concept of relfection of light', 'comprehension', 1),
                                         ('distinguish regular from irregular relfection of light',
                                          'comprehension',
                                          2),
                                         ('describe image formed by a plane mirror', 'comprehension', 3),
                                         ('explain the origin of charges', 'comprehension', 4),
                                         ('identify the two types of charges', 'comprehension', 5),
                                         ('state the fundamental law of static electricity; and',
                                          'comprehension',
                                          6)]},
                           {'title': 'Detection of Charges',
                            'code': '6.4',
                            'order': 4,
                            'periods': 4,
                            'outcomes': [('describe the structure of a gold leaf electroscope',
                                          'comprehension',
                                          1),
                                         ('determine the sign of charges; and', 'comprehension', 2)]},
                           {'title': 'Capacitors',
                            'code': '6.6',
                            'order': 6,
                            'periods': 4,
                            'outcomes': [('explain the concept of capacitance', 'comprehension', 1),
                                         ('describe the construction of an air-iflled capacitor; and',
                                          'comprehension',
                                          2),
                           ...
                           {'title': 'Lightning Conductor',
                            ...
                            'order': 7,
                            'periods': 4,
                            'outcomes': [('show that charge on a conductor is concentrated on sharply curved '
                                          'surfaces',
                                          'comprehension',
                                          1),
            ...
            {'title': 'CURRENT ELECTRICITY',
             ...
             'subtopics': [{'title': 'Concept of Current Electricity',
                            ...
                            'order': 1,
                            'periods': 3,
                            'outcomes': [('construct a simple lightning conductor', 'comprehension', 1),
                                         ('deifne current electricity; and', 'comprehension', 2)]},
                           {'title': 'Simple Electric Circuits',
                            'code': '1.2',
                            'order': 2,
                            'periods': 2,
                            'outcomes': [('identify simple circuit components', 'comprehension', 1),
                                         ('identify simple electric symbols', 'comprehension', 2),
                                         ('explain the concept of current, voltage and resistance',
                                          'comprehension',
                                          3),
                                         ('connect simple electric circuits', 'comprehension', 4),
                                         ('measure electric current and voltage; and',
                                          'comprehension',
                                          5)]}]},
            {'title': 'MAGNETISM',
             'code': '2.0',
             ...
             'subtopics': [{'title': 'Concept of Magnetism',
                            ...
                            'order': 1,
                            'periods': 2,
                            'outcomes': [('explain the origin of magnetism', 'comprehension', 1),
                                         ('identify magnetic and non-magnetic materials/ substances',
                                          'comprehension',
                                          2),
                                         ('identify types of magnets; and', 'comprehension', 3),
                                         ('identify applications of magnets', 'comprehension', 4),
                                         ('demonstrate magnetization and demagnetization',
                                          'comprehension',
                                          5),
                                         ('design methods of storing magnets', 'comprehension', 6),
                                         ('illustrate the magnetic lines of force around a magnet using iron '
                                          'ifllings or compass needle; and',
                                          'comprehension',
                                          7),
                                         ('explain the method of magnetic shielding', 'comprehension', 8),
                                         ('Compass needle i', 'comprehension', 9),
                                         ('Retort stand i', 'comprehension', 10),
                                         ('World globe', 'comprehension', 11),
                                         ('Bar magnet i', 'comprehension', 12),
                                         ('Retort stand', 'comprehension', 13),
                                         ('Iron ifllings', 'comprehension', 14)]}]},
            {'title': 'FORCES IN EQUILIBRIUM',
             ...
             'periods': 17,
             'weight': 'high',
             'subtopics': [{'title': 'Moment of a Force',
                            'code': '3.1',
                            'order': 1,
                            'periods': 3,
                            'outcomes': [('state the applications of earth’s magnetic ifeld',
                                          'comprehension',
                                          1),
                                         ('explain the effects of turning forces', 'comprehension', 2),
                                         ('determine the moment of force', 'comprehension', 3)]},
                           {'title': 'Center of Gravity',
                            'code': '3.2',
                            'order': 2,
                            'periods': 3,
                            'outcomes': [('apply the principle of moments in daily life', 'comprehension', 1),
                                         ('explain centre of gravity', 'comprehension', 2),
                                         ('determine center of gravity of regular shaped body; and',
                                          'comprehension',
                                          3)]},
                           {'title': 'Types of equilibrium',
                            ...
                            'order': 3,
                            'periods': 3,
                            'outcomes': [('explain the conditions for equilibrium', 'comprehension', 1),
                                         ('explain stable, unstable and neutral equilibrium; and',
                                          'comprehension',
                                          2),
                                         ('apply conditions of stable, unstable and neutral equilibrium in '
                                          'daily life',
                                          'comprehension',
                                          3),
                                         ('explain the terms applied in simple machines; and',
                                          'comprehension',
                                          4),
                                         ('identify the different kinds of simple machines',
                                          'comprehension',
                                          5),
                                         ('determine the mechanical advantage, velocity ratio and efifciency '
                                          'of lever; and',
                                          'comprehension',
                                          6)]},
                           {'title': 'Pulleys',
                            ...
                            'order': 4,
                            'periods': 2,
                            'outcomes': [('identify different pulley systems; and', 'comprehension', 1),
                                         ('determine, mechanical advantage, velocity ratio and efifciency of '
                                          'pulley system',
                                          'comprehension',
                                          2)]},
                           {'title': 'Inclined Plane',
                            ...
                            'order': 5,
                            'periods': 2,
                            'outcomes': [('state the concept of inclined plane', 'comprehension', 1),
                                         ('determine mechanical advantage, velocity ratio and efifciency of '
                                          'inclined plane',
                                          'comprehension',
                                          2),
                                         ('apply inclined plane in daily life', 'comprehension', 3)]},
                           {'title': 'Wheel and Axle',
                            'code': '3.6',
                            'order': 6,
                            'periods': 2,
                            'outcomes': [('determine the mechanical advantage, velocity ratio and efifciency '
                                          'of a screw jack; and',
                                          'comprehension',
                                          1),
                                         ('use the screw jack in daily life', 'comprehension', 2),
                                         ('describe the structure of a wheel and axle', 'comprehension', 3)]},
                           {'title': 'Hydraulic Press',
                            'code': '3.7',
                            'order': 7,
                            'periods': 2,
                            'outcomes': [('use the wheel and axle in daily life', 'comprehension', 1),
            ...
            {'title': 'MOTION IN STRAIGHT LINE',
             ...
             'periods': 7,
             'weight': 'medium',
             'subtopics': [{'title': 'Distance and Displacement',
                            'code': '4.1',
                            'order': 1,
                            'periods': 3,
                            'outcomes': [('use the hydraulic press in daily life', 'comprehension', 1),
                           ...
                           {'title': 'Speed and Velocity',
                            ...
                            'outcomes': [('distinguish between speed and velocity', 'comprehension', 1),
                                         ('state the SI unit of speed and velocity; and', 'comprehension', 2),
                                         ('determine average velocity of a body', 'comprehension', 3),
                                         ('determine the acceleration of a body; and', 'comprehension', 4),
                                         ('explain the concept of retardation', 'comprehension', 5)]},
                           {'title': 'Motion under Gravity',
                            'code': '4.3',
                            'order': 3,
                            'periods': 2,
                            'outcomes': [('apply equations of accelerated motion in daily life',
                                          'comprehension',
                                          1),
                                         ('explain the concept of gravitational force',
                                          'comprehension',
                                          2)]}]},
            {'title': 'NEWTON’S LAWS OF MOTION 1st',
             'code': '5.0',
             'form_level': 2,
             'order': 5,
             'periods': 7,
             'weight': 'medium',
             'subtopics': [{'title': 'Law of Motion.',
                            'code': '5.1',
                            'order': 1,
                            'periods': 3,
                            'outcomes': [('explain the applications of gravitational force',
                                          'comprehension',
                                          1),
                                         ('explain the concept of inertia', 'comprehension', 2)]},
                           {'title': 'Law of Motion',
                            'code': '5.2',
                            'order': 2,
                            'periods': 2,
                            'outcomes': [('verify Newton’s first law of motion', 'comprehension', 1),
                                         ('explain concept of linear momentum', 'comprehension', 2),
                                         ('state the S.I unit of linear momentum', 'comprehension', 3),
                                         ('state Newton’s second law of motion and', 'comprehension', 4)]},
                           {'title': 'Conservation of Linear Momentum',
                            'code': '5.3',
                            'order': 3,
                            'periods': 2,
                            'outcomes': [('distinguish between elastic and inelastic collisions',
                                          'comprehension',
                                          1),
                                         ('state the principle of conservation of linear momentum',
                                          'comprehension',
                                          2),
                                         ('punch bags i', 'comprehension', 3),
                                         ('car air bags ii', 'comprehension', 4),
                                         ('pool table i', 'comprehension', 5),
                                         ('kicking a ball conservation', 'comprehension', 6),
                                         ('Bicycle pump ii', 'comprehension', 7)]}]},
            {'title': 'TEMPERATURE',
             'code': '6.0',
             'form_level': 2,
             'order': 6,
             'periods': 5,
             'weight': 'low',
             'subtopics': [{'title': 'Concept of Temperature',
                            'code': '6.1',
                            'order': 1,
                            'periods': 3,
                            'outcomes': [('apply Newton’s third law of motion', 'comprehension', 1),
                                         ('deifne the term temperature; and', 'comprehension', 2)]},
                           {'title': 'Measurement of Temperature',
                            'code': '6.2',
                            'order': 2,
                            'periods': 2,
                            'outcomes': [('identify measurable physical properties that change with '
                                          'temperature',
                                          'comprehension',
                                          1),
                                         ('deifne the fundamental interval of a thermometer',
                                          'comprehension',
                                          2)]}]},
            {'title': 'SUSTAINABLE ENERGY SOURCES',
             ...
             'periods': 9,
             'weight': 'medium',
             'subtopics': [{'title': 'Water Energy',
                            'code': '7.1',
                            'order': 1,
                            'periods': 3,
                            'outcomes': [('measure accurately the temperature of a body', 'comprehension', 1),
                                         ('explain the generation of electricity from water',
                                          'comprehension',
                                          2),
                                         ('explain the importance of water energy; and',
                                          'comprehension',
                                          3)]},
                           {'title': 'Solar Energy',
                            'code': '7.2',
                            'order': 2,
                            'periods': 2,
                            'outcomes': [('explain the sun as a source of energy', 'comprehension', 1)]},
                           {'title': 'Wind Energy',
                            'code': '7.3',
                            'order': 3,
                            'periods': 2,
                            'outcomes': [('construct a model of solar panel', 'comprehension', 1),
                                         ('explain wind as a source of energy', 'comprehension', 2),
                                         ('construct a model of a wind mill; and', 'comprehension', 3),
                                         ('Diagram of sea wave energy plant i', 'comprehension', 4),
                                         ('Sea wave charts', 'comprehension', 5),
                                         ('Cardboard i', 'comprehension', 6),
                                         ('Scissors ii', 'comprehension', 7),
                                         ('Diagram of geothermal plant i', 'comprehension', 8),
                                         ('add vectors using graphical method; and', 'comprehension', 9),
                                         ('state the triangle and parallelogram laws of forces',
                                          'comprehension',
                                          10),
                                         ('calculate the relative velocity of two bodies; and',
                                          'comprehension',
                                          11),
                                         ('apply the concept of relative motion in daily life',
                                          'comprehension',
                                          12),
                                         ('resolve a vector into two perpendicular components; and',
                                          'comprehension',
                                          13),
                                         ('apply resolution of vectors in solving problems',
                                          'comprehension',
                                          14),
                                         ('realize the advantages and disadvantages of friction in daily '
                                          'life; and',
                                          'comprehension',
                                          15),
                                         ('describe methods of reducing friction', 'comprehension', 16)]},
                           {'title': 'Laws of Friction',
                            'code': '7.4',
                            'order': 4,
                            'periods': 2,
                            'outcomes': [('determine limiting friction', 'comprehension', 1),
                                         ('state laws of friction', 'comprehension', 2),
                                         ('determine the coefifcient of friction; and',
                                          'comprehension',
                                          3)]}]},
            {'title': 'LIGHT',
             'code': '1.0',
