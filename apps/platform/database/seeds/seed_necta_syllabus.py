...
NECTA_SYLLABUS: list[dict] = [
 ...
 'topics': [{'title': 'NUMBERS',
             ...
             'subtopics': [{'title': 'Base ten numeration',
                            ...
                            'order': 1,
                            'periods': 8,
                            'outcomes': [('Identify the place value of each digit in base ten numeration',
                                          'knowledge',
                                          1),
                                         ('Read numbers in base ten numeration up to one billion',
                                          'knowledge',
                                          2),
                                         ...
                                         ('Explain the basic concepts of Mathematics (Meaning of '
                                          'mathematics, branches of mathematics, relationship between '
                                          'mathematics and other subjects, importance of mathematic',
                                          'comprehension',
                                          0),
                           ...
                           {'title': 'Natural and whole numbers',
                            ...
                            'order': 2,
                            'periods': 14,
                            'outcomes': [('Distinguish between natural numbers and whole numbers',
                                          'comprehension',
                                          1),
                                         ('Identify even, odd and prime numbers', 'knowledge', 2),
                                         ('Show even, odd and prime numbers on number line',
                                          'application',
                                          3),
                                         ('Find factors of a given number', 'application', 4),
                                         ('Use factors to find the Greatest Common Factor (GCF)',
                                          'application',
                                          5),
                                         ('Use factors or multiples to find the Lowest Common Multiple (LCM)',
                                          'application',
                                          6),
                                         ('Explain the concept of rational, irrational, and real numbers',
                                          'comprehension',
                                          0),
                                         ('Explain the concept of inequalities and absolute values of real '
                                          'numbers',
                                          'comprehension',
                                          0)]},
                           {'title': 'Integers',
                            ...
                            'order': 3,
                            'periods': 12,
                            'outcomes': [('Identify integers in real life situations', 'comprehension', 1),
                                         ...
                                         ('Convert repeating/ recurring decimals into fractions and vice '
                                          'versa',
                                          'comprehension',
                                          0),
            ...
            {'title': 'FRACTIONS',
             ...
             'periods': 28,
             'weight': 'high',
             'subtopics': [{'title': 'Proper, improper and mixed numbers',
                            'code': '2.1',
                            'order': 1,
                            'periods': 8,
                            'outcomes': [('Describe a fraction', 'comprehension', 1),
                           ...
                           {'title': 'Comparison of fractions',
                            ...
                            'order': 2,
                            'periods': 10,
                            'outcomes': [('Simplify a fraction to its lowest terms', 'application', 1),
                                         ('Compare and order fractions', 'application', 2)]},
                           {'title': 'Operations on fractions',
                            'code': '2.3',
                            'order': 3,
                            'periods': 10,
                            'outcomes': [('Add fractions', 'application', 1),
            ...
            {'title': 'DECIMALS AND APPROXIMATIONS',
             ...
             'periods': 20,
             'weight': 'medium',
             'subtopics': [{'title': 'Place value of decimals',
                            'code': '3.1',
                            'order': 1,
                            'periods': 6,
                            'outcomes': [('Identify the place value of digits in decimal numbers',
                                          'knowledge',
                                          1),
                                         ('Convert fractions to decimals and vice versa', 'application', 2),
                                         ('Explain the concept of approximations (rounding off, significant '
                                          'figures, and decimal place',
                                          'comprehension',
                                          0),
                                         ('Use approximations in computations and measurements of quantities '
                                          'in various contexts',
                                          'comprehension',
                                          0),
                                         ('Describe the concepts of geometry (similarities and congruenc',
                                          'comprehension',
                                          0),
                                         ('Describe the concepts of relations and functions (linear and '
                                          'quadrati',
                                          'comprehension',
                                          0),
                           ...
                           {'title': 'Operations on decimals',
                            ...
                            'order': 2,
                            'periods': 8,
                            'outcomes': [('Perform addition and subtraction of decimals', 'application', 1),
                                         ...
                                         ('Round off numbers and estimate values of expressions',
                                          'comprehension',
                                          0),
                                         ('Recognize properties of similar triangles', 'comprehension', 0),
                                         ('(types of relations, domain and range of relations, graphs of '
                                          'relations and functions, inverse of relations, and function',
                                          'comprehension',
                                          0),
                                         ('Draw graphs of relations and functions', 'comprehension', 0)]},
                           {'title': 'Approximations',
                            'code': '3.3',
                            'order': 3,
                            'periods': 6,
                            'outcomes': [('Round off numbers to given degrees of accuracy', 'application', 1),
                                         ('Estimate results of computations', 'application', 2),
                                         ('Approximate numbers to the required significant figures and '
                                          'decimal places',
                                          'comprehension',
                                          0),
            ...
            {'title': 'RATIOS, PROPORTIONS AND PERCENTAGES',
             ...
             'periods': 24,
             'weight': 'high',
             'subtopics': [{'title': 'Ratio and ratio calculations',
                            'code': '4.1',
                            'order': 1,
                            'periods': 8,
                            'outcomes': [('Simplify ratios', 'application', 1),
                           ...
                           {'title': 'Direct and inverse proportions',
                            ...
                            'order': 2,
                            'periods': 8,
                            'outcomes': [('Solve problems involving direct proportion', 'application', 1),
                                         ('Solve problems involving inverse proportion', 'application', 2),
                                         ('Solve ratio and proportion problems', 'comprehension', 0)]},
                           {'title': 'Percentages',
                            'code': '4.3',
                            'order': 3,
                            'periods': 8,
                            'outcomes': [('Convert fractions and decimals to percentages and vice versa',
                                          'application',
                                          1),
                                         ('Solve problems involving percentages including profit, loss, '
            ...
            {'title': 'COMMERCIAL ARITHMETIC',
             ...
             'periods': 16,
             'weight': 'medium',
             'subtopics': [{'title': 'Profit and loss',
                            'code': '5.1',
                            'order': 1,
                            'periods': 6,
                            'outcomes': [('Calculate profit and loss', 'application', 1),
                                         ('Calculate profit/loss percentage', 'application', 2)]},
                           {'title': 'Simple interest',
                            'code': '5.2',
                            'order': 2,
                            'periods': 6,
                            'outcomes': [('Calculate simple interest using I = PRT/100', 'application', 1),
                                         ('Solve problems involving simple interest', 'application', 2)]},
                           {'title': 'Discount and tax',
                            'code': '5.3',
                            'order': 3,
                            'periods': 4,
                            'outcomes': [('Calculate discount and selling price', 'application', 1),
            ...
            {'title': 'SETS',
             ...
             'periods': 16,
             'weight': 'medium',
             'subtopics': [{'title': 'Definition and notation of sets',
                            'code': '6.1',
                            'order': 1,
                            'periods': 4,
                            'outcomes': [('Define a set and describe sets using roster and set-builder '
                                          'notation',
                                          'comprehension',
                                          1),
                                         ('Identify types of sets: empty, universal, finite, infinite, '
                                          'equal, equivalent',
                                          'knowledge',
                                          2)]},
                           {'title': 'Operations on sets',
                            ...
                            'order': 2,
                            'periods': 6,
                            'outcomes': [('Perform union of sets', 'application', 1),
            ...
            {'title': 'ALGEBRA',
             ...
             'periods': 20,
             'weight': 'high',
             'subtopics': [{'title': 'Algebraic expressions',
                            'code': '7.1',
                            'order': 1,
                            'periods': 6,
                            'outcomes': [('Identify variables, constants, coefficients and terms in '
                                          'algebraic expressions',
                                          'knowledge',
                                          1),
                                         ('Simplify algebraic expressions', 'application', 2),
                                         ('Explore the basic tenets of algebra (algebraic expressions and '
                                          'equations, linear simultaneous equations of two unknowns, '
                                          'inequalities in one unknow',
                                          'comprehension',
                                          0),
                                         ('Solve inequalities in one unknown', 'comprehension', 0),
                                         ('Explore the basic tenets of algebra (binary operations, quadratic '
                                          'expressions and equations, radicals, exponents, and logarithm',
                                          'comprehension',
                                          0),
                                         ('Write numbers in standard form', 'comprehension', 0),
                                         ('Explore the basic tenets of matrices ( 2×2 matrices: operations, '
                                          'determinant, inverse, and transformation',
                                          'comprehension',
                                          0)]},
                           {'title': 'Linear equations in one unknown',
                            ...
                            'order': 2,
                            'periods': 8,
                            'outcomes': [('Solve linear equations in one unknown', 'application', 1),
                                         ('Formulate linear equations from word problems', 'analysis', 2),
                                         ('Use algebraic expressions to model situations (word problems into '
                                          'algebraic expressions and equation',
                                          'comprehension',
                                          0),
                                         ('Solve quadratic equations by using different methods '
                                          '(factorisation, Completing the square, and quadratic formul',
                                          'comprehension',
                                          0),
                                         ('Use laws of logarithms to solve problems', 'comprehension', 0),
                                         ('Apply matrices to solve simultaneous equations of two unknowns '
                                          '(matrix inversion method and Cramer’s rul',
                                          'comprehension',
                                          0)]},
                           {'title': 'Linear inequalities in one unknown',
                            ...
                            'order': 3,
                            'periods': 6,
                            'outcomes': [('Solve linear inequalities in one unknown', 'application', 1),
                                         ...
                                         ('Solve simultaneous equations using substitution and elimination '
                                          ...
                                          'comprehension',
                                          0),
                                         ('Identify and use laws of exponents involving positive, negative, '
                                          'and zero exponents (multiplication law, division law, power law, '
                                          'and zero inde',
                                          'comprehension',
                                          0),
            ...
            {'title': 'COORDINATE GEOMETRY',
             ...
             'periods': 12,
             'weight': 'medium',
             'subtopics': [{'title': 'The Cartesian plane',
                            'code': '8.1',
                            'order': 1,
                            'periods': 4,
                            'outcomes': [('Locate points on the Cartesian plane', 'application', 1),
                                         ('Identify coordinates of points on the Cartesian plane',
                                          'knowledge',
                                          2),
                                         ('Explore the basic tenets of coordinate geometry (gradient and '
                                          'equations of a straight line, graphs of linear equation',
                                          'comprehension',
                                          0),
                                         ('Determine the equation of a straight line and draw its graph',
                                          'comprehension',
                                          0),
                                         ('Use mathematical software to solve and draw graphs of '
                                          'simultaneous equations',
                                          'comprehension',
                                          0),
                                         ('Explore the basic tenets of trigonometry (trigonometric ratios, '
                                          'angles of elevation and depressio',
                                          'comprehension',
                                          0),
                           ...
                           {'title': 'Linear equations in two variables',
                            ...
                            'order': 2,
                            'periods': 8,
                            'outcomes': [('Draw graphs of linear equations in two variables',
                                          'application',
                                          1),
                                         ('Determine the gradient and intercepts of a straight line',
                                          'analysis',
                                          2),
                                         ('Find the equation of a straight line given two points',
                                          'synthesis',
                                          3),
                                         ('Find the gradient/ slope of a line', 'comprehension', 0),
            ...
            {'title': 'MENSURATION',
             ...
             'periods': 18,
             'weight': 'high',
             'subtopics': [{'title': 'Length and perimeter',
                            'code': '9.1',
                            'order': 1,
                            'periods': 6,
                            'outcomes': [('Calculate perimeter of triangles, rectangles, parallelograms and '
                                          'circles',
                                          'application',
                                          1)]},
                           {'title': 'Area',
                            ...
                            'order': 2,
                            'periods': 6,
                            'outcomes': [('Calculate area of triangles, rectangles, parallelograms, '
                                          'trapeziums and circles',
                                          'application',
                                          1),
                                         ('Solve problems involving area of combined shapes',
                                          'analysis',
                                          2)]},
                           {'title': 'Volume',
                            'code': '9.3',
                            'order': 3,
                            'periods': 6,
                            'outcomes': [('Calculate volume of cubes, cuboids, cylinders and triangular '
                                          'prisms',
                                          'application',
                                          1),
            ...
            {'title': 'ANGLES AND LINES',
             ...
             'periods': 16,
             'weight': 'medium',
             'subtopics': [{'title': 'Types of angles and angle properties',
                            'code': '10.1',
                            'order': 1,
                            'periods': 6,
                            'outcomes': [('Identify types of angles: acute, right, obtuse, straight, reflex',
                                          'knowledge',
                                          1),
                           ...
                           {'title': 'Angles formed by parallel lines and a transversal',
                            ...
                            'order': 2,
                            'periods': 6,
                            'outcomes': [('Identify corresponding, alternate and co-interior angles',
                                          'knowledge',
                                          1),
                                         ('Calculate angles formed by parallel lines and a transversal',
                                          'application',
                                          2)]},
                           {'title': 'Construction of angles',
                            ...
                            'order': 3,
                            'periods': 4,
                            'outcomes': [('Construct angles of given sizes using a compass and ruler',
                                          'application',
                                          1)]}]},
 ...
 'form_start': 1,
 'form_end': 6,
 'topics': [{'title': 'INTRODUCTION TO CHEMISTRY',
             'code': '1.0',
             'form_level': 1,
             'order': 1,
             'periods': 10,
             'weight': 'low',
             'subtopics': [{'title': 'What is Chemistry?',
                            'code': '1.1',
                            'order': 1,
                            'periods': 4,
                            'outcomes': [('Define Chemistry and its importance in daily life',
                                          'comprehension',
                                          1),
                                         ('Identify careers related to Chemistry', 'knowledge', 2),
                                         ('Describe the concept of Chemistry (meaning, branches, '
                                          'applications and relationships with other discipline',
                                          'comprehension',
                                          0),
                                         ('Describe the concept of matter (physical and chemical changes of '
                                          'matte',
                                          'comprehension',
                                          0),
                                         (', compounds (binary compoun', 'comprehension', 0),
                                         ('Compare the properties of compounds with those of constituent '
                                          'elements',
                                          'comprehension',
                                          0),
                                         ('Describe basic Chemistry laboratory skills (chemistry laboratory '
                                          'rules and safety measures, first aid, fire and firefighting, and '
                                          'Chemistry laboratory apparatu',
                                          'comprehension',
                                          0),
                                         ('Perform experiments on separation of different mixtures using '
                                          'different methods',
                                          'comprehension',
                                          0),
                                         ('Describe the modern concept of atomic structure (Dalton’s atomic '
                                          'structure and sub- atomic particle',
                                          'comprehension',
                                          0),
                                         ('Use the concept of atomic structure to determine the atomic and '
                                          'mass numbers of an element',
                                          'comprehension',
                                          0),
                                         ('Determine empirical and molecular formulae of common compounds',
                                          'comprehension',
                                          0),
                                         ('Describe the concept of chemical reactions (chemical equations, '
                                          'balancing chemical equations, and types of chemical reaction',
                                          'comprehension',
                                          0),
                                         ('Describe acids, bases and salts (reactions of acids and bases '
                                          'with various substance',
                                          'comprehension',
                                          0),
                                         ('Prepare acid- base indicators using locally available materials',
                                          'comprehension',
                                          0),
                                         ('Describe the mole concept (comparison of the mole with other '
                                          'units of measurements and molar quantities of substance',
                                          'comprehension',
                                          0),
                                         ('Explain the principles of volumetric analysis (preparation of '
                                          'standard solutions and volumetric calculation',
                                          'comprehension',
                                          0),
                                         ('Explore the basic tenets of ionic theory and electrolysis (ionic '
                                          'theory, mechanism of electrolysis and laws of electrolysi',
                                          'comprehension',
                                          0),
                                         ('Describe the oxidizing and displacement properties of non-metal '
                                          'compounds (oxygen, hydrogen, chlorine, hydrogen chloride, sulphur '
                                          'dioxide, nitrogen, ammonia, and carbon dioxid',
                                          'comprehension',
                                          0),
                                         ('Perform experiments on volumetric analysis', 'comprehension', 0),
                                         ('Use appropriate software to sketch the set-ups of experiments',
                                          'comprehension',
                                          0),
                                         ('Demonstrate oxidizing and displacement properties of non-metallic '
                                          'compounds (oxygen, hydrogen, chlorine, hydrogen chloride, sulphur '
                                          'dioxide, nitrogen, ammonia and carbon dioxid',
                                          'comprehension',
                                          0),
                                         ('Design and carry-out a simple research project in Chemistry',
                                          'comprehension',
                                          0),
                                         ('Investigate the composition of chemical species in substances '
                                          'using systematic qualitative analysis',
                                          'comprehension',
                                          0),
                                         ('Complete and submit a report for the project started in Form '
                                          'Three',
                                          'comprehension',
                                          0)]},
                           {'title': 'Laboratory apparatus and safety',
                            ...
                            'order': 2,
                            'periods': 6,
                            'outcomes': [('Identify common chemistry laboratory apparatus and their uses',
                                          'knowledge',
                                          1),
                                         ('Observe laboratory safety rules', 'comprehension', 2),
                                         ('Discuss the contribution of Chemistry in the development of '
                                          'modern society',
                                          'comprehension',
                                          0),
                                         ('Describe the concepts of chemical elements (criteria for '
                                          'assigning chemical symbol',
                                          'comprehension',
                                          0),
                                         ('and mixtures (types of solution and separation of mixture',
                                          'comprehension',
                                          0),
                                         ('Explain the concept of the periodic table (1st 20 elements in the '
                                          'Periodic Table; metals and non- metal',
                                          'comprehension',
                                          0),
                                         ('Perform experiments on the changes of matter from one state to '
                                          'another',
                                          'comprehension',
                                          0),
                                         ('Describe the concept of electronic arrangements',
                                          'comprehension',
                                          0),
                                         ('Explain the concept of chemical formulae and nomenclature '
                                          '(valence, oxidation state, radicals and naming of binary '
                                          'inorganic compounds using the IUPAC syste',
                                          'comprehension',
                                          0),
                                         ('Describe the concept of chemical bonding (covalent and '
                                          'electrovalent bondin',
                                          'comprehension',
                                          0),
                                         ('Relate the types of chemical reactions with common processes in '
                                          'daily life such as burning of fuel and digestion in living '
                                          'organisms',
                                          'comprehension',
                                          0),
                                         ('and their applications in daily life', 'comprehension', 0),
                                         ('Use the prepared indicators to test acidity and alkalinity of '
                                          'substances found in the locality',
                                          'comprehension',
                                          0),
                                         ('Explain Avogadro’s law in relation to molar quantities',
                                          'comprehension',
                                          0),
                                         ('Describe the applications of volumetric analysis in real life and '
                                          'industrial settings as in soft drinks and cocktail making, '
                                          'medicine and in agriculture',
                                          'comprehension',
                                          0),
                                         ('Describe the preparation and properties of various compounds of '
                                          'metals (oxides, hydroxides, carbonates, hydrogen carbonates, '
                                          'nitrates, chlorides and sulphates of metal',
                                          'comprehension',
                                          0),
                                         ('Perform experiments on the applications of electrolysis in '
                                          'corrosion inhibition and purification of metals',
                                          'comprehension',
                                          0),
                                         ('Prepare various compounds of metals (oxides, hydroxides, '
                                          'carbonates, hydrogen carbonates, nitrates, chlorides, and '
                                          'sulphate',
                                          'comprehension',
                                          0),
                                         ('Prepare sulphuric acid from sulphur dioxide', 'comprehension', 0),
                                         ('Demonstrate the local and industrial preparations of aliphatic '
            ...
            {'title': 'SIMPLE CLASSIFICATION OF MATTER',
             ...
             'periods': 18,
             'weight': 'high',
             'subtopics': [{'title': 'States of matter and changes of state',
                            'code': '2.1',
                            'order': 1,
                            'periods': 6,
                            'outcomes': [('Describe the three states of matter and their properties',
                                          'comprehension',
                                          1),
                                         ('Explain changes of state: melting, freezing, evaporation, '
                           ...
                           {'title': 'Elements, compounds and mixtures',
                            ...
                            'order': 2,
                            'periods': 6,
                            'outcomes': [('Distinguish between elements, compounds and mixtures',
                                          'analysis',
                                          1),
                                         ('Separate mixtures using: filtration, distillation, '
                                          'chromatography, sublimation, magnetic separation',
                                          'application',
                                          2)]},
                           {'title': 'Solutions',
                            'code': '2.3',
                            'order': 3,
                            'periods': 6,
                            'outcomes': [('Define solute, solvent and solution', 'knowledge', 1),
                                         ('Describe saturation and solubility', 'comprehension', 2),
                                         ('Calculate concentration of solutions in g/dm³ and mol/dm³',
                                          'application',
                                          3)]}]},
            {'title': 'AIR AND COMBUSTION',
             ...
             'periods': 14,
             'weight': 'medium',
             'subtopics': [{'title': 'Composition of air',
                            'code': '3.1',
                            'order': 1,
                            'periods': 4,
                            'outcomes': [('State the composition of air: nitrogen (78%), oxygen (21%), other '
                                          'gases (1%)',
                                          'knowledge',
                                          1),
                                         ('Describe the role of oxygen in combustion and respiration',
                                          'comprehension',
                                          2)]},
                           {'title': 'Rusting and its prevention',
                            ...
                            'order': 2,
                            'periods': 6,
                            'outcomes': [('Explain the conditions necessary for rusting', 'comprehension', 1),
                                         ('Describe methods of preventing rusting', 'comprehension', 2)]},
                           {'title': 'Air pollution',
                            'code': '3.3',
                            'order': 3,
                            'periods': 4,
                            'outcomes': [('Identify causes and effects of air pollution', 'knowledge', 1),
            ...
            {'title': 'WATER AND HYDROGEN',
             ...
             'periods': 16,
             'weight': 'medium',
             'subtopics': [{'title': 'Properties and uses of water',
                            'code': '4.1',
                            'order': 1,
                            'periods': 6,
                            'outcomes': [('Describe physical and chemical properties of water',
                                          'comprehension',
                                          1),
                                         ('Explain water pollution and purification methods',
                                          'comprehension',
                                          2)]},
                           {'title': 'Hydrogen',
                            'code': '4.2',
                            'order': 2,
                            'periods': 6,
                            'outcomes': [('Describe laboratory preparation of hydrogen gas',
                                          'comprehension',
                                          1),
                                         ('Describe the properties and uses of hydrogen',
                                          'comprehension',
                                          2)]},
                           {'title': 'Hard and soft water',
                            ...
                            'order': 3,
                            'periods': 4,
                            'outcomes': [('Distinguish between temporary and permanent hard water',
                                          'analysis',
                                          1),
 ...
 'form_start': 1,
 'form_end': 6,
 'topics': [{'title': 'BIOLOGY AND ITS APPLICATIONS',
             'code': '1.0',
             'form_level': 1,
             'order': 1,
             'periods': 10,
             'weight': 'low',
             'subtopics': [{'title': 'What is Biology?',
                            'code': '1.1',
                            'order': 1,
                            'periods': 6,
                            'outcomes': [('Define Biology and its branches: botany, zoology, microbiology, '
                                          'genetics, ecology',
                                          'knowledge',
                                          1),
                                         ('Identify biology-related careers', 'knowledge', 2),
                                         ('Explain the basic concepts of Biology (meaning, branches, basic '
                                          'terminologies, importance and its relationship with other '
                                          'discipline',
                                          'comprehension',
                                          0),
                                         ('Describe nutrition in plants (photosynthesis, leaf structure and '
                                          'mineral requirement',
                                          'comprehension',
                                          0),
                                         ('Explain the concept and systems of classification (meaning '
                                          ',importance of classification, rules of scientific naming of '
                                          'organisms',
                                          'comprehension',
                                          0),
                                         ('Describe the basic skills for conducting biological experiments '
                                          '(observation, measurement and experimentatio',
                                          'comprehension',
                                          0),
                                         ('Carry out investigations related to photosynthesis (conditions '
                                          'necessary for photosynthesi',
                                          'comprehension',
                                          0),
                                         ('Describe nutrition in human and ruminants (nutrients, digestive '
                                          'system and processe',
                                          'comprehension',
                                          0),
                                         ('Describe the mechanism of transportation of materials in the '
                                          'human body (the mammalian heart, blood vessels, blood, blood '
                                          'circulatio',
                                          'comprehension',
                                          0),
                                         ('Describe the mechanism of gaseous exchange in plants (parts of '
                                          'plants responsible for gaseous exchange and the proces',
                                          'comprehension',
                                          0),
                                         ...
                                         ('Carry out experiments to determine the pulse rate in human',
                                          'comprehension',
                                          0),
                                         ('Describe coordination in plants (tropic, response',
                                          'comprehension',
                                          0),
                                         ('Describe the mechanism of excretion in the human body (systems: '
                                          'organs, product',
                                          'comprehension',
                                          0),
                                         ('Investigate the process of nervous coordination (reflex arc and '
                                          'knee jer',
                                          'comprehension',
                                          0),
                                         ('Develop and carry out a simple research project in Biology',
                                          'comprehension',
                                          0),
                                         ('Describe reproduction in plants (concept of reproduction in '
                                          'plants, asexual and sexual reproduction, pollination and '
                                          'fertilizatio',
                                          'comprehension',
                                          0),
                                         ('Describe the mechanisms of growth in mammals and flowering plants '
                                          '(concept of growth, mitosis and growth, growth and developmental '
                                          'stages in human and seed germinatio',
                                          'comprehension',
                                          0),
                                         ('Carry out investigation related to reproduction in flowering '
                                          'plants (flower structure and embry',
                                          'comprehension',
                                          0),
                                         ('Complete and submit a report for the research project started in '
                                          'Form Three',
                                          'comprehension',
                                          0)]},
                           {'title': 'Cell biology basics',
                            ...
                            'order': 2,
                            'periods': 4,
                            'outcomes': [('Describe the cell theory', 'comprehension', 1),
                                         ('Identify structures of plant and animal cells', 'knowledge', 2),
                                         ('Describe a cell (meaning,types, structures and function',
                                          'comprehension',
                                          0),
                                         ('Describe the major groups of organisms: (Monera, Protista, Fungi, '
                                          'Plantae, Animalia and Viruse',
                                          'comprehension',
                                          0),
                                         ('Carry out microscopic observation of a cell', 'comprehension', 0),
                                         ('Describe the mechanism of transportation of materials in '
                                          'flowering plants (vascular system, absorption and movement of '
                                          'water and mineral salts and transpiratio',
                                          'comprehension',
                                          0),
                                         ('Describe the mechanisms of gaseous exchange and respiration in '
                                          'mammals (gaseous exchange in mammals, aerobic and anaerobic '
                                          'respiratio',
                                          'comprehension',
                                          0),
                                         ('Investigate processes of transportation of materials in flowering '
                                          'plants',
                                          'comprehension',
                                          0),
                                         ('Investigate aerobic and anaerobic respiration in living organisms',
                                          'comprehension',
                                          0),
                                         ('and animals (nervous coordination in human, structure of '
                                          'neurones, sense organs and endocrine syste',
                                          'comprehension',
                                          0),
                                         ('Describe the mechanism of regulation in the human body '
                                          '(temperature regulation, blood sugar regulation and osmoregulatio',
                                          'comprehension',
                                          0),
                                         ('Investigate tropic responses in plants', 'comprehension', 0),
                                         ('Describe reproduction in humans (sexual reproduction in human, '
                                          'fertilization, pregnancy and child birt',
                                          'comprehension',
                                          0),
                                         ('Explore the basic tenets of genetics (genetic materials, '
                                          'principles of inhertance, monohybrid, Mendelian and non-Mendelian '
                                          'inheritance; variation',
                                          'comprehension',
                                          0),
                                         ('Investigate growth in flowering plants (hypogeal and epigeal '
                                          'germinatio',
                                          'comprehension',
                                          0)]}]},
            {'title': 'CELL STRUCTURE AND ORGANIZATION',
             ...
             'periods': 20,
             'weight': 'high',
             'subtopics': [{'title': 'Cell structure',
                            'code': '2.1',
                            'order': 1,
                            'periods': 8,
                            'outcomes': [('Identify organelles: nucleus, mitochondria, ribosomes, '
                                          'endoplasmic reticulum, Golgi apparatus, lysosomes, vacuoles, cell '
                                          'membrane, cell wall, chloroplasts',
                                          'knowledge',
                                          1),
                                         ('Distinguish between plant and animal cells', 'analysis', 2),
                                         ('Prepare and present a report on cell and photosynthesis '
                                          'investigations',
                                          'comprehension',
                                          0),
                                         ('Prepare and present a report of a biological investigation on ( '
                                          'food nutrients in various food samples, transportation of '
                                          'materials in flowering plants, pulse rate in human, aerobic and '
                           ...
                           {'title': 'Levels of organization',
                            ...
                            'order': 2,
                            'periods': 6,
                            'outcomes': [('Describe levels of organization: cell → tissue → organ → organ '
                                          'system → organism',
                                          'comprehension',
                                          1),
                                         ('Identify tissues: epithelial, connective, muscular, nervous',
                                          'knowledge',
                                          2)]},
                           {'title': 'Cell division',
                            'code': '2.3',
                            'order': 3,
                            'periods': 6,
                            'outcomes': [('Describe mitosis and its significance', 'comprehension', 1),
            ...
            {'title': 'NUTRITION',
             ...
             'periods': 20,
             'weight': 'high',
             'subtopics': [{'title': 'Modes of nutrition',
                            'code': '3.1',
                            'order': 1,
                            'periods': 6,
                            'outcomes': [('Describe autotrophic and heterotrophic nutrition',
                                          'comprehension',
                                          1),
                                         ('Identify types of heterotrophic nutrition: holozoic, saprophytic, '
                                          'parasitic, symbiotic',
                                          'knowledge',
                                          2)]},
                           {'title': 'Plant nutrition',
                            ...
                            'order': 2,
                            'periods': 8,
                            'outcomes': [('Describe photosynthesis: 6CO₂ + 6H₂O → C₆H₁₂O₆ + 6O₂',
                                          'comprehension',
                                          1),
                           ...
                           {'title': 'Human nutrition',
                            ...
                            'order': 3,
                            'periods': 6,
                            'outcomes': [('Identify classes of food and their functions', 'knowledge', 1),
                                         ('Describe the human alimentary canal and functions of its parts',
                                          'comprehension',
                                          2),
                                         ('Describe nutrition disorders: kwashiorkor, marasmus, rickets, '
                                          'scurvy, goitre',
                                          'comprehension',
                                          3)]}]},
