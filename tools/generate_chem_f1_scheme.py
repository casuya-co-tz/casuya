"""Chemistry Form 1 scheme of work generator.

Builds the verified Chemistry Form One scheme of work JSON for Term I
(10 teaching weeks, 2 periods per week).

Run directly (`python generate_chem_f1_scheme.py`) or via the thin wrapper
`generate_chem_f1.py`.
"""
import json
...
def generate():
    ...
    print("Generated chemistry_form_one_scheme.json")
